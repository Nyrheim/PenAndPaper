...
public class ActiveCharacterRecord extends UpdatableRecordImpl<ActiveCharacterRecord> implements Record2<Integer, Integer> {

    private static final long serialVersionUID = -1506802142;

    /**
     * Setter for <code>nyrheim.active_character.player_id</code>.
     */
    ...
    /**
     * Getter for <code>nyrheim.active_character.player_id</code>.
     */
    ...
    public Field<Integer> field1() {
        return ActiveCharacter.ACTIVE_CHARACTER.PLAYER_ID;
    }
    ...
    @Override
    public ActiveCharacterRecord value1(Integer value) {
        setPlayerId(value);
        return this;
    }
    ...
    @Override
    public ActiveCharacterRecord values(Integer value1, Integer value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public ActiveCharacterRecord(Integer playerId, Integer characterId) {
        super(ActiveCharacter.ACTIVE_CHARACTER);
